...
public class ISSCore {
    ...
    public static final ResourceKey<DamageType> ISS_FIRE_MAGIC = ResourceKey.create(
            Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "fire_magic"));
    public static final ResourceKey<DamageType> ISS_ICE_MAGIC = ResourceKey.create(
            Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "ice_magic"));
    ...
    public static final ResourceKey<DamageType> ISS_NATURE_MAGIC = ResourceKey.create(
            Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "nature_magic"));
    ...
    public static final ResourceKey<DamageType> ISS_ENDER_MAGIC = ResourceKey.create(
            Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "ender_magic"));
    public static final ResourceKey<DamageType> ISS_BLOOD_MAGIC = ResourceKey.create(
            Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "blood_magic"));
    public static final ResourceKey<DamageType> ISS_EVOCATION_MAGIC = ResourceKey.create(
            Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "evocation_magic"));
    public static final ResourceKey<DamageType> ISS_ELDRITCH_MAGIC = ResourceKey.create(
            Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "eldritch_magic"));
    ...
    static {
        ...
        if (ISS_LOADED) {
            try {
                Class<?> spellOnCastClass = Class.forName("io.redspace.ironsspellbooks.api.events.SpellOnCastEvent");
                @SuppressWarnings("unchecked")
                Class<? extends net.neoforged.bus.api.Event> eventClass =
                        (Class<? extends net.neoforged.bus.api.Event>) spellOnCastClass;
                net.neoforged.neoforge.common.NeoForge.EVENT_BUS.addListener(
                        EventPriority.NORMAL, false, eventClass, ISSCore::onSpellOnCast);
            } catch (Exception e) {
                ElementalCraft.LOGGER.error("Failed to register ISS SpellOnCast listener", e);
            }
    ...
    public static void onCasterMobSpellHit(net.neoforged.neoforge.event.entity.living.LivingDamageEvent.Pre event) {
    ...
    public static void throwSplashPoisonBottle(Mob mob, LivingEntity target) {
        ...
        poisonBottle.set(DataComponents.POTION_CONTENTS, new PotionContents(Potions.POISON));
    ...
    static boolean isImmuneToParalysis(LivingEntity entity) {
        var entityId = BuiltInRegistries.ENTITY_TYPE
    ...
    static int tryGetStacksFromItem(LivingEntity attacker) {
        ...
        try {
            ...
            try {
                ...
                Object invOpt = curiosApi.getMethod("getCuriosInventory", LivingEntity.class).invoke(null, attacker);
                if (invOpt instanceof java.util.Optional<?> inv && inv.isPresent()) {
                    Object slotOpt = inv.get().getClass().getMethod("findCurio", String.class, int.class)
                            .invoke(inv.get(), "spellbook", 0);
                    if (slotOpt instanceof java.util.Optional<?> opt && opt.isPresent()) {
