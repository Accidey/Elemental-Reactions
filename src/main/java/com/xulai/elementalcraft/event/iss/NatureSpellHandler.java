...
public class NatureSpellHandler {
    ...
    private static final net.minecraft.core.Holder<net.minecraft.world.effect.MobEffect> REND_EFFECT =
            BuiltInRegistries.MOB_EFFECT.getHolder(net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("irons_spellbooks", "rend")).orElse(null);

    @SubscribeEvent(priority = EventPriority.HIGHEST)
    public static void onNatureSpellHit(LivingDamageEvent.Pre event) {
    ...
    @SubscribeEvent
    public static void onLivingTickCheckRoot(EntityTickEvent.Post event) {
        if (event.getEntity().level().isClientSide) return;
        if (!ISSCore.ISS_LOADED) return;
    ...
    private static boolean isRootEntity(Entity entity) {
        ...
        net.minecraft.resources.ResourceLocation key = net.minecraft.core.registries.BuiltInRegistries.ENTITY_TYPE.getKey(entity.getType());
