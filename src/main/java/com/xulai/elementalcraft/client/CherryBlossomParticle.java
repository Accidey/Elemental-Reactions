...
public class CherryBlossomParticle extends SingleQuadParticle {
    ...
    protected CherryBlossomParticle(
        ...
        this.rCol = 0.95f + this.random.nextFloat() * 0.05f;
        this.gCol = 0.5f + this.random.nextFloat() * 0.15f;
        this.bCol = 0.6f + this.random.nextFloat() * 0.15f;
        this.alpha = 0.85f;
        this.xd = xSpeed;
        this.yd = ySpeed;
        this.zd = zSpeed;
        this.driftSeed = this.random.nextFloat();
        this.rollSpeed = (float)Math.toRadians(this.random.nextBoolean() ? -5.0 : 5.0);
        this.oRoll = (float)Math.toRadians(this.random.nextBoolean() ? -30.0 : 30.0);
    }
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public net.minecraft.client.particle.Particle createParticle(
            ...
            return new CherryBlossomParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, this.sprites);
        }
    }
}
