...
public class ElementalFireNatureReactionsConfig {
    ...
    public static final ModConfigSpec.IntValue WETNESS_MAX_LEVEL;
    public static final ModConfigSpec.IntValue WETNESS_SHALLOW_WATER_CAP;
    public static final ModConfigSpec.DoubleValue WETNESS_FIRE_REDUCTION;
    public static final ModConfigSpec.IntValue WETNESS_RAIN_GAIN_INTERVAL;
    public static final ModConfigSpec.IntValue WETNESS_DECAY_BASE_TIME;
    public static final ModConfigSpec.DoubleValue WETNESS_EXHAUSTION_INCREASE;
    public static final ModConfigSpec.IntValue WETNESS_POTION_ADD_LEVEL;
    public static final ModConfigSpec.IntValue WETNESS_DRYING_THRESHOLD;
    public static final ModConfigSpec.DoubleValue WETNESS_SELF_DRYING_DAMAGE_PENALTY;
    public static final ModConfigSpec.IntValue WETNESS_FIRE_DRYING_TIME;
    public static final ModConfigSpec.DoubleValue WETNESS_HEAT_SEARCH_RADIUS;
    public static final ModConfigSpec.DoubleValue WETNESS_HEAT_ACCELERATE_RADIUS;
    public static final ModConfigSpec.DoubleValue WETNESS_HEAT_ACCELERATE_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue WETNESS_BIOME_ACCELERATE_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue WETNESS_COLD_BIOME_DECAY_SLOWDOWN;

    public static final ModConfigSpec.BooleanValue WETNESS_WATER_ANIMAL_IMMUNE;
    public static final ModConfigSpec.BooleanValue WETNESS_NETHER_DIMENSION_IMMUNE;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> WETNESS_ENTITY_BLACKLIST;
    public static final ModConfigSpec.IntValue SPORE_MAX_STACKS;
    public static final ModConfigSpec.IntValue SPORE_REACTION_THRESHOLD;
    public static final ModConfigSpec.DoubleValue SPORE_POISON_DAMAGE;
    public static final ModConfigSpec.IntValue SPORE_DAMAGE_INTERVAL;
    public static final ModConfigSpec.DoubleValue SPORE_FIRE_VULN_PER_STACK;
    public static final ModConfigSpec.IntValue SPORE_DURATION_PER_STACK;
    public static final ModConfigSpec.DoubleValue SPORE_FIRE_DURATION_REDUCTION;
    public static final ModConfigSpec.DoubleValue SPORE_NATURE_DURATION_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue SPORE_THUNDER_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue SPORE_FROST_DURATION_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue SPORE_COLD_BIOME_DURATION_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue SPORE_COLD_BIOME_CHANCE_MULTIPLIER;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> SPORE_ENTITY_BLACKLIST;
    public static final ModConfigSpec.DoubleValue SPORE_DURABILITY_PERCENT;
    public static final int CONTAGION_CHECK_INTERVAL = 20;
    public static final ModConfigSpec.DoubleValue CONTAGION_BASE_RADIUS;
    public static final ModConfigSpec.DoubleValue CONTAGION_RADIUS_PER_STACK;
    public static final ModConfigSpec.IntValue CONTAGION_TRANSFER_BASE;
    public static final ModConfigSpec.BooleanValue CONTAGION_ONLY_HOSTILE;
    public static final ModConfigSpec.BooleanValue CONTAGION_ALLOW_INFECTED_SPREAD;
    public static final ModConfigSpec.BooleanValue CONTAGION_ALLOW_REINFECTED;
    public static final ModConfigSpec.DoubleValue NATURE_PARASITE_BASE_THRESHOLD;
    public static final ModConfigSpec.DoubleValue NATURE_PARASITE_BASE_CHANCE;
    public static final ModConfigSpec.DoubleValue NATURE_PARASITE_SCALING_STEP;
    public static final ModConfigSpec.DoubleValue NATURE_PARASITE_SCALING_CHANCE;
    public static final ModConfigSpec.IntValue NATURE_PARASITE_AMOUNT;
    public static final ModConfigSpec.DoubleValue NATURE_PARASITE_WETNESS_BONUS;
    public static final ModConfigSpec.DoubleValue NATURE_PARASITE_STACKING_BONUS;
    public static final ModConfigSpec.IntValue NATURE_IMMUNITY_THRESHOLD;
    public static final ModConfigSpec.DoubleValue WILDFIRE_TRIGGER_THRESHOLD;
    public static final ModConfigSpec.DoubleValue WILDFIRE_HEALTH_RECOVERY_THRESHOLD;
    public static final ModConfigSpec.DoubleValue WILDFIRE_RADIUS;
    public static final ModConfigSpec.DoubleValue WILDFIRE_KNOCKBACK;
    public static final ModConfigSpec.DoubleValue WILDFIRE_VERTICAL_KNOCKBACK;
    public static final ModConfigSpec.IntValue WILDFIRE_SPORE_AMOUNT;
    public static final ModConfigSpec.BooleanValue WILDFIRE_CLEAR_BURNING;
    public static final ModConfigSpec.DoubleValue WILDFIRE_BLOOD_THRESHOLD;
    public static final ModConfigSpec.DoubleValue FIRE_COUNTER_BLOOD_THRESHOLD;
    public static final ModConfigSpec.DoubleValue FIRE_COUNTER_STRENGTH_THRESHOLD;
    public static final ModConfigSpec.DoubleValue FIRE_COUNTER_HEALTH_RECOVERY_THRESHOLD;
    public static final ModConfigSpec.DoubleValue FIRE_COUNTER_RADIUS;
    public static final ModConfigSpec.DoubleValue FIRE_COUNTER_EXPANSION_SPEED;
    public static final ModConfigSpec.DoubleValue FIRE_COUNTER_DAMAGE;
    public static final ModConfigSpec.DoubleValue FIRE_COUNTER_KNOCKBACK;
    public static final ModConfigSpec.DoubleValue FIRE_COUNTER_DAMAGE_REDUCTION;
    public static final ModConfigSpec.DoubleValue BLAST_WEAK_IGNITE_MULT;
    public static final ModConfigSpec.DoubleValue BLAST_BASE_DAMAGE;
    public static final ModConfigSpec.DoubleValue BLAST_GROWTH_DAMAGE;
    public static final ModConfigSpec.DoubleValue BLAST_BASE_RANGE;
    public static final ModConfigSpec.DoubleValue BLAST_GROWTH_RANGE;
    public static final ModConfigSpec.DoubleValue BLAST_GROWTH_SCORCH_TIME;

    public static final ModConfigSpec.BooleanValue SPORE_ENVIRONMENTAL_BLAST_ENABLED;
    public static final ModConfigSpec.BooleanValue SPORE_HEAT_BLAST_ENABLED;
    public static final ModConfigSpec.DoubleValue BLAST_MAX_BLAST_PROT_CAP;
    public static final ModConfigSpec.DoubleValue BLAST_MAX_GENERAL_PROT_CAP;
    public static final ModConfigSpec.DoubleValue ENCHANTMENT_CALCULATION_DENOMINATOR;
    public static final ModConfigSpec.IntValue STEAM_HIGH_HEAT_MAX_LEVEL;
    public static final ModConfigSpec.IntValue STEAM_LOW_HEAT_MAX_LEVEL;
    public static final ModConfigSpec.IntValue STEAM_HIGH_HEAT_TRIGGER_THRESHOLD;
    public static final ModConfigSpec.IntValue STEAM_LOW_HEAT_TRIGGER_THRESHOLD;
    public static final ModConfigSpec.IntValue STEAM_TRIGGER_COOLDOWN;
    public static final ModConfigSpec.DoubleValue STEAM_CLOUD_RADIUS;
    public static final ModConfigSpec.DoubleValue STEAM_RADIUS_PER_LEVEL;
    public static final ModConfigSpec.IntValue STEAM_CLOUD_DURATION;
    public static final ModConfigSpec.IntValue STEAM_DURATION_PER_LEVEL;
    public static final ModConfigSpec.BooleanValue STEAM_CLEAR_AGGRO;
    public static final ModConfigSpec.DoubleValue STEAM_CLOUD_HEIGHT_CEILING;
    public static final ModConfigSpec.IntValue STEAM_CONDENSATION_DELAY;
    public static final ModConfigSpec.DoubleValue STEAM_CONDENSATION_RADIUS;
    public static final ModConfigSpec.IntValue STEAM_CONDENSATION_DURATION_BASE;
    public static final ModConfigSpec.IntValue STEAM_CONDENSATION_DURATION_PER_LEVEL;

    public static final ModConfigSpec.DoubleValue STEAM_SCALDING_DAMAGE;
    public static final ModConfigSpec.DoubleValue STEAM_DAMAGE_SCALE_PER_LEVEL;
    public static final ModConfigSpec.DoubleValue STEAM_SCALDING_MULTIPLIER_FIRE;
    public static final ModConfigSpec.DoubleValue STEAM_SCALDING_MULTIPLIER_NATURE;
    public static final ModConfigSpec.DoubleValue STEAM_SCALDING_MULTIPLIER_THUNDER;
    public static final ModConfigSpec.DoubleValue STEAM_SCALDING_MULTIPLIER_FROST;
    public static final ModConfigSpec.IntValue STEAM_IMMUNITY_THRESHOLD;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> STEAM_IMMUNITY_BLACKLIST;
    public static final ModConfigSpec.DoubleValue STEAM_MAX_FIRE_PROT_CAP;
    public static final ModConfigSpec.DoubleValue STEAM_MAX_GENERAL_PROT_CAP;
    public static final ModConfigSpec.IntValue SCORCHED_TRIGGER_THRESHOLD;
    public static final ModConfigSpec.DoubleValue SCORCHED_BASE_CHANCE;
    public static final ModConfigSpec.IntValue SCORCHED_CHANCE_PER_POINT;
    public static final ModConfigSpec.IntValue SCORCHED_DURATION;
    public static final ModConfigSpec.IntValue SCORCHED_COOLDOWN;
    public static final ModConfigSpec.DoubleValue SCORCHED_DAMAGE_BASE;
    public static final ModConfigSpec.IntValue SCORCHED_DAMAGE_SCALING_STEP;
    public static final ModConfigSpec.IntValue SCORCHED_RESIST_THRESHOLD;
    public static final ModConfigSpec.DoubleValue SCORCHED_IMMUNE_MODIFIER;
    public static final ModConfigSpec.DoubleValue SCORCHED_FIRE_PROT_REDUCTION;
    public static final ModConfigSpec.DoubleValue SCORCHED_SHOCK_DAMAGE_RATIO;
    public static final ModConfigSpec.DoubleValue SCORCHED_GEN_PROT_REDUCTION;
    public static final ModConfigSpec.DoubleValue SCORCHED_FIRE_DURATION_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue SCORCHED_NATURE_DURATION_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue SCORCHED_THUNDER_DURATION_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue SCORCHED_FROST_DURATION_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue POISON_SCORCH_DURATION_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue POISON_SCORCH_DAMAGE_MULTIPLIER;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> SCORCHED_ENTITY_BLACKLIST;
    public static final ModConfigSpec.DoubleValue SCORCHED_HOT_BIOME_CHANCE_BONUS;
    public static final ModConfigSpec.DoubleValue SCORCHED_COLD_BIOME_CHANCE_PENALTY;
    public static final ModConfigSpec.IntValue SCORCHED_AURA_FIRE_POWER_THRESHOLD;
    public static final ModConfigSpec.DoubleValue SCORCHED_AURA_RADIUS;
    public static final ModConfigSpec.BooleanValue SCORCHED_AURA_STEAM_ENABLED;
    public static final ModConfigSpec.BooleanValue SCORCHED_AURA_SPORE_DETONATION_ENABLED;

    public static final ModConfigSpec.DoubleValue SCORCHED_FROST_DMG_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue SCORCHED_NATURE_DMG_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue SCORCHED_FIRE_DMG_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue SCORCHED_THUNDER_DMG_MULTIPLIER;
