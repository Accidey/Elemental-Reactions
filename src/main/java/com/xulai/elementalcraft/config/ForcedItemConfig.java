...
public final class ForcedItemConfig {
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> FORCED_WEAPONS;

    public static final ModConfigSpec.ConfigValue<List<? extends String>> FORCED_ARMOR;
