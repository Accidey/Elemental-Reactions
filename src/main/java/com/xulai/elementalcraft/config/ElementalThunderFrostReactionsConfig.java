...
public final class ElementalThunderFrostReactionsConfig {
    ...
    public static final ModConfigSpec.IntValue THUNDER_STRENGTH_THRESHOLD;
    public static final ModConfigSpec.DoubleValue STATIC_BASE_CHANCE;
    public static final ModConfigSpec.IntValue STATIC_SCALING_STEP;
    public static final ModConfigSpec.DoubleValue STATIC_SCALING_CHANCE;
    public static final ModConfigSpec.DoubleValue STATIC_WETNESS_BONUS_CHANCE_PER_LEVEL;
    public static final ModConfigSpec.DoubleValue STATIC_STACKING_BONUS_CHANCE;
    public static final ModConfigSpec.DoubleValue STATIC_THUNDERSTORM_BONUS_CHANCE;
    public static final ModConfigSpec.IntValue STATIC_MAX_STACKS_PER_ATTACK;
    public static final ModConfigSpec.IntValue STATIC_MAX_TOTAL_STACKS;
    public static final ModConfigSpec.IntValue STATIC_DURATION_PER_STACK_TICKS;

    public static final ModConfigSpec.IntValue STATIC_RESIST_IMMUNITY_THRESHOLD;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> STATIC_IMMUNITY_BLACKLIST;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> PARALYSIS_IMMUNITY_BLACKLIST;

    public static final ModConfigSpec.DoubleValue STATIC_DAMAGE_MIN;
    public static final ModConfigSpec.DoubleValue STATIC_DAMAGE_MAX;
    public static final ModConfigSpec.IntValue STATIC_DAMAGE_INTERVAL_TICKS;

    public static final ModConfigSpec.DoubleValue STATIC_DAMAGE_FIRE_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue STATIC_DAMAGE_NATURE_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue STATIC_DAMAGE_THUNDER_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue STATIC_DAMAGE_FROST_MULTIPLIER;

    public static final ModConfigSpec.IntValue STATIC_AURA_THRESHOLD;
    public static final ModConfigSpec.DoubleValue STATIC_AURA_BASE_RANGE;
    public static final ModConfigSpec.DoubleValue STATIC_AURA_HEIGHT_CEILING;

    public static final ModConfigSpec.DoubleValue THUNDER_COUNTER_BLOOD_THRESHOLD;
    public static final ModConfigSpec.IntValue THUNDER_COUNTER_STRENGTH_THRESHOLD;
    public static final ModConfigSpec.DoubleValue THUNDER_COUNTER_HEALTH_RECOVERY_THRESHOLD;
    public static final ModConfigSpec.DoubleValue THUNDER_COUNTER_RADIUS;
    public static final ModConfigSpec.DoubleValue THUNDER_COUNTER_EXPANSION_SPEED;
    public static final ModConfigSpec.DoubleValue COUNTER_LIGHTNING_DAMAGE;

    public static final ModConfigSpec.IntValue PARALYSIS_MAX_STACKS;
    public static final ModConfigSpec.IntValue PARALYSIS_DURATION_PER_STACK_TICKS;
    public static final ModConfigSpec.DoubleValue PARALYSIS_DAMAGE_PERCENTAGE;
    public static final ModConfigSpec.IntValue PARALYSIS_COOLDOWN_TICKS;

    public static final ModConfigSpec.DoubleValue STATIC_SPORE_BLAST_BASE_CHANCE;
    public static final ModConfigSpec.DoubleValue STATIC_SPORE_BLAST_PER_STATIC_STACK;
    public static final ModConfigSpec.DoubleValue STATIC_SPORE_BLAST_PER_SPORE_STACK;
    public static final ModConfigSpec.DoubleValue STATIC_CREEPER_IGNITE_CHANCE;


    public static final ModConfigSpec.DoubleValue STATIC_MAX_PROT_CAP;
    public static final ModConfigSpec.DoubleValue STATIC_MAX_PROJECTILE_PROT_CAP;

    public static final ModConfigSpec.IntValue STATIC_STEAM_CLOUD_TRIGGER_STACKS;

    public static final ModConfigSpec.DoubleValue WATER_ELECTRIFICATION_RANGE_BASE;
    public static final ModConfigSpec.DoubleValue WATER_ELECTRIFICATION_RANGE_PER_STACK;
    public static final ModConfigSpec.IntValue WATER_ELECTRIFICATION_PARALYSIS_DURATION;

    public static final ModConfigSpec.DoubleValue FROST_STRENGTH_THRESHOLD;
    public static final ModConfigSpec.DoubleValue FROSTBITE_BASE_CHANCE;
    public static final ModConfigSpec.DoubleValue FROSTBITE_SCALING_STEP;
    public static final ModConfigSpec.DoubleValue FROSTBITE_SCALING_CHANCE;
    public static final ModConfigSpec.DoubleValue FROSTBITE_WETNESS_BONUS_CHANCE;
    public static final ModConfigSpec.DoubleValue FROSTBITE_STACKING_BONUS_CHANCE;
    public static final ModConfigSpec.DoubleValue FROSTBITE_HOT_BIOME_CHANCE_PENALTY;
    public static final ModConfigSpec.DoubleValue FROSTBITE_COLD_BIOME_CHANCE_BONUS;
    public static final ModConfigSpec.IntValue FROSTBITE_MAX_STACKS_PER_ATTACK;
    public static final ModConfigSpec.IntValue FROSTBITE_MAX_TOTAL_STACKS;
    public static final ModConfigSpec.IntValue FROSTBITE_BASE_DURATION_TICKS;
    public static final ModConfigSpec.IntValue FROSTBITE_DURATION_PER_EXTRA_STACK_TICKS;
    public static final ModConfigSpec.DoubleValue FROSTBITE_SPEED_REDUCTION_PER_STACK;
    public static final ModConfigSpec.DoubleValue FROSTBITE_PERIODIC_DAMAGE;
    public static final ModConfigSpec.IntValue FROSTBITE_DAMAGE_INTERVAL_TICKS;
    public static final ModConfigSpec.IntValue FROSTBITE_RESIST_IMMUNITY_THRESHOLD;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> FROSTBITE_IMMUNITY_BLACKLIST;

    public static final ModConfigSpec.DoubleValue FROSTBITE_DAMAGE_FIRE_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue FROSTBITE_DAMAGE_NATURE_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue FROSTBITE_DAMAGE_THUNDER_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue FROSTBITE_DAMAGE_FROST_MULTIPLIER;

    public static final ModConfigSpec.IntValue FREEZE_MAX_STACKS;
    public static final ModConfigSpec.IntValue FREEZE_DURATION_PER_STACK_TICKS;

    public static final ModConfigSpec.DoubleValue FREEZE_SETTLEMENT_DAMAGE_PER_STACK;
    public static final ModConfigSpec.IntValue FREEZE_COOLDOWN_TICKS;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> FREEZE_IMMUNITY_BLACKLIST;
    public static final ModConfigSpec.DoubleValue WETNESS_COLD_BIOME_FREEZE_CHANCE;
    public static final ModConfigSpec.DoubleValue WETNESS_COLD_BIOME_FREEZE_LEVEL_BONUS;

    public static final ModConfigSpec.DoubleValue THUNDER_BREAK_FREEZE_CHANCE;
    public static final ModConfigSpec.IntValue THUNDER_BREAK_FREEZE_TO_WETNESS_RATIO;

    public static final ModConfigSpec.IntValue FROSTBITE_FIRE_STEAM_THRESHOLD;
    public static final ModConfigSpec.DoubleValue FIRE_FROST_MELT_DAMAGE_MULT;
    public static final ModConfigSpec.IntValue FIRE_FROST_MELT_WETNESS_RATIO;

    public static final ModConfigSpec.DoubleValue FROSTBITE_SPORE_DECAY_SPEED;

    public static final ModConfigSpec.BooleanValue FREEZE_CLEAR_SPORES_ENABLED;

    public static final ModConfigSpec.IntValue SCORCHED_FROSTBITE_TO_WETNESS_RATIO;

    public static final ModConfigSpec.BooleanValue FROSTBITE_CLEAR_BY_HEAT_ENABLED;
    public static final ModConfigSpec.DoubleValue FROSTBITE_HEAT_SEARCH_RADIUS;
    public static final ModConfigSpec.IntValue FROSTBITE_FIRE_STAND_CLEARING_TIME;

    public static final ModConfigSpec.DoubleValue FROSTBITE_HEAT_ACCELERATE_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue FROSTBITE_HEAT_ACCELERATE_RADIUS;

    public static final ModConfigSpec.IntValue FROSTBITE_AURA_THRESHOLD;
    public static final ModConfigSpec.DoubleValue FROSTBITE_AURA_BASE_RANGE;
    public static final ModConfigSpec.DoubleValue FROSTBITE_AURA_RANGE_PER_STACK;

    public static final ModConfigSpec.IntValue FROSTED_STEAM_CLOUD_TRIGGER_STACKS;

    public static final ModConfigSpec.DoubleValue FROST_COUNTER_BLOOD_THRESHOLD;
    public static final ModConfigSpec.IntValue FROST_COUNTER_STRENGTH_THRESHOLD;
    public static final ModConfigSpec.DoubleValue FROST_COUNTER_HEALTH_RECOVERY_THRESHOLD;
    public static final ModConfigSpec.DoubleValue FROST_COUNTER_MAX_RADIUS;
    public static final ModConfigSpec.DoubleValue FROST_COUNTER_EXPANSION_SPEED;
    public static final ModConfigSpec.DoubleValue FROST_COUNTER_HEIGHT_CEILING;
