...
public final class ElementalConfig {
    ...
    public static final ModConfigSpec.DoubleValue MOB_ATTRIBUTE_CHANCE_HOSTILE;
    public static final ModConfigSpec.DoubleValue MOB_ATTRIBUTE_CHANCE_NEUTRAL;
    public static final ModConfigSpec.DoubleValue ATTACK_ATTRIBUTE_CHANCE;
    public static final ModConfigSpec.DoubleValue COUNTER_RESIST_CHANCE;
    ...
    public static final ModConfigSpec.IntValue STRENGTH_PER_HALF_DAMAGE;
    public static final ModConfigSpec.IntValue RESIST_PER_HALF_REDUCTION;
    public static final ModConfigSpec.DoubleValue ELEMENTAL_DAMAGE_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue ELEMENTAL_RESISTANCE_MULTIPLIER;
    public static final ModConfigSpec.IntValue MAX_STAT_CAP;

    public static final ModConfigSpec.DoubleValue RESTRAINT_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue WEAK_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue RESTRAINT_MIN_DAMAGE_PERCENT;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> ELEMENT_RESTRAINTS;

    public static final ModConfigSpec.ConfigValue<List<? extends String>> FORCED_ENTITIES;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> BLACKLISTED_ENTITIES;

    public static final ModConfigSpec.BooleanValue MOB_FLEE_ENABLED;
    public static final ModConfigSpec.BooleanValue POTION_STACK_64;

    public static final ModConfigSpec.BooleanValue MOB_POTION_THROW_ENABLED;
    public static final ModConfigSpec.DoubleValue MOB_BOTTLE_EQUIP_CHANCE;
    public static final ModConfigSpec.IntValue MOB_BOTTLE_THROW_COOLDOWN;

    public static final ModConfigSpec.DoubleValue ENCHANTED_BOOK_DROP_CHANCE;
    public static final ModConfigSpec.DoubleValue ENCHANTED_BOOK_LOOTING_BONUS;
    public static final ModConfigSpec.DoubleValue ENCHANTED_BOOK_LEVEL_SPREAD;

    public static final ModConfigSpec.BooleanValue NETHER_DIMENSION_FORCED_FIRE;
    public static final ModConfigSpec.IntValue NETHER_FIRE_POINTS;
    public static final ModConfigSpec.BooleanValue END_DIMENSION_FORCED_THUNDER;
    public static final ModConfigSpec.IntValue END_THUNDER_POINTS;

    public static final ModConfigSpec.DoubleValue HOT_FIRE_BIAS;
    public static final ModConfigSpec.DoubleValue COLD_FROST_BIAS;
    public static final ModConfigSpec.DoubleValue FOREST_NATURE_BIAS;
    public static final ModConfigSpec.DoubleValue THUNDERSTORM_THUNDER_BIAS;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> CUSTOM_BIOME_ATTRIBUTE_BIAS;
