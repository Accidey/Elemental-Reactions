...
public final class ElementalISSIntegrationConfig {
    ...
    public static final ModConfigSpec.DoubleValue MOB_LOW_HEALTH_THRESHOLD;
    public static final ModConfigSpec.IntValue MOB_AGGRESSIVE_CAST_COOLDOWN;
    public static final ModConfigSpec.IntValue MOB_NORMAL_CAST_COOLDOWN;
    public static final ModConfigSpec.IntValue MOB_BOTTLE_THROW_COOLDOWN;
    public static final ModConfigSpec.DoubleValue SCROLL_DROP_CHANCE;

    public static final ModConfigSpec.DoubleValue CASTER_MOB_CHANCE;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> CASTER_MOB_BLACKLIST;
