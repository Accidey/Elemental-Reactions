...
public final class CustomBiomeBias {
    ...
    private static final Map<Identifier, Map<ElementType, Double>> BIOME_BIAS_CACHE = new ConcurrentHashMap<>();
    ...
    public static Map<ElementType, Double> getCustomBias(Identifier id) {
